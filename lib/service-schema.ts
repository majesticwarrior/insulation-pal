export const createServiceSchemas = (serviceName: string, serviceUrl: string) => {
  ...
  return {
    service: {
      ...
      "description": `Professional ${serviceName.toLowerCase()} by licensed contractors`,
      "provider": {
        "@type": "Organization",
        "name": "InsulationPal",
        "url": siteUrl,
      ...
      "serviceType": `${serviceName} Installation`,
    ...
    breadcrumb: {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": serviceName, "item": `${siteUrl}${serviceUrl}` }
      ]
    }
  }
}
