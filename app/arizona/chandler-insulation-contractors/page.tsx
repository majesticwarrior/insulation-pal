...
// Generate dynamic metadata based on Chandler contractor data
export async function generateMetadata(): Promise<Metadata> {
  try {
    const contractors = await getChandlerContractors()
    const contractorCount = contractors.length
    const topContractor = contractors[0]
    
    const baseTitle = 'Chandler Insulation Contractors'
    ...
    return {
      ...
      keywords: [
        ...
        'Chandler attic insulation',
        'Chandler spray foam insulation',
        'Chandler wall insulation',
        'Chandler basement insulation',
        'Chandler crawl space insulation',
        'Chandler energy efficiency',
        'Arizona insulation services',
        'Chandler insulation quotes',
        'licensed insulation contractors Chandler',
        'verified insulation professionals Chandler'
      ],
      openGraph: {
      ...
      alternates: {
        canonical: 'https://insulationpal.com/arizona/chandler-insulation-contractors',
      },
    }
  } catch (error) {
    return {
      title: 'Chandler Insulation Contractors - InsulationPal',
      description: 'Find the best insulation contractors in Chandler, AZ. Get free quotes from licensed professionals.',
    }
  }
}


// Fetch Chandler contractors from Supabase database
async function getChandlerContractors() {
  try {
    // Get contractors based in Chandler (business city from their profile)
...
// Fetch Chandler contractor reviews
async function getPhoenixReviews() {
  try {
    // Try to fetch reviews with location containing Chandler
    const { data: locationReviews, error: locationError } = await (supabase as any)
      ...
      `)
      .eq('contractors.status', 'approved')
      .ilike('location', '%Chandler%')
      .order('created_at', { ascending: false })
      .limit(10)

    // Try to fetch reviews from contractors based in Chandler
    const { data: contractorReviews, error: contractorError } = await (supabase as any)
      ...
      `)
      .eq('contractors.status', 'approved')
      .ilike('contractors.business_city', '%Chandler%')
      .order('created_at', { ascending: false })
      .limit(10)
    ...
    // If no Chandler reviews found, fallback to Phoenix reviews
...
// Add Chandler area cities with 50k+ population
const chandlerAreaCities = [
...
export default async function ChandlerInsulationContractors() {
  ...
  const cityStats = {
    totalReviews: chandlerContractors.reduce((sum: number, contractor: any) => sum + contractor.reviewCount, 0),
    averageRating: chandlerContractors.length > 0 ? 
      (chandlerContractors.reduce((sum: number, contractor: any) => sum + contractor.rating, 0) / chandlerContractors.length).toFixed(1) : 
      '4.8',
    totalContractors: chandlerContractors.length,
    jobsCompleted: chandlerContractors.reduce((sum: number, contractor: any) => sum + contractor.jobsCompleted, 0)
  }
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-700 mb-8">
              ...
              licensed professionals who understand Chandler's unique climate challenges.
            </p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-3 gap-8">
            <Card>
              <CardHeader>
                <CardTitle className="text-[#0a4768]">Insulation Types for Chandler</CardTitle>
              </CardHeader>
              <CardContent>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="space-y-8">
            {chandlerContractors.map((contractor: any) => (
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {chandlerAreaCities.map((city, index) => (
      ...
      <section className="py-8 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="rounded-lg overflow-hidden shadow-lg">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d424562.4818431687!2d-111.95077996445466!3d33.30689243162149!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x872b608d57b8b7af%3A0x24b085177b1d98db!2sChandler%2C%20AZ!5e0!3m2!1sen!2sus!4v1709562834567"
              width="100%"
              height="450"
              style={{ border: 0 }}
              allowFullScreen
              ...
              title="Chandler, Arizona - Service Area Map"
            />
          </div>
          <div className="text-center mt-6">
            <p className="text-gray-600 mb-4">
              Our certified insulation contractors serve all cities and communities throughout Chandler and the surrounding East Valley area.
            </p>
            <Button 
              asChild 
              variant="outline"
            ...
            >
              <Link 
                href="https://www.google.com/maps/place/Chandler,+AZ"
                target="_blank"
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600">
              See what customers are saying about our Chandler insulation contractors
            </p>
          </div>
      ...
      <section className="py-16 bg-[#D6D6D6] text-[#0a4768]">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">
            Ready to Improve Your Chandler Home?
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Connect with Chandler's most trusted insulation contractors. Get free quotes from verified professionals 
            who understand the unique insulation needs of desert homes.
          </p>
          <QuoteButton className="bg-[#F5DD22] hover:bg-[#f0d000] text-[#0a4768] font-semibold px-8 py-3 text-lg">
            Get Chandler Quotes Now
          </QuoteButton>
        </div>
      </section>
