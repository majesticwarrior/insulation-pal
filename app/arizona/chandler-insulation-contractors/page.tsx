...
// Fetch recent insulation projects completed in Chandler
async function getChandlerRecentProjects() {
  try {
...
export default async function ChandlerInsulationContractors() {
  ...
  const recentProjects = await getChandlerRecentProjects()
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4 max-w-[1400px]">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Learn the basics of home insulation and why it's crucial for Chandler homes
            </p>
          </div>
