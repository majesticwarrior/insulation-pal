...
// Fetch recent insulation projects completed in Surprise
async function getSurpriseRecentProjects() {
  try {
...
export default async function SurpriseInsulationContractors() {
  ...
  const recentProjects = await getSurpriseRecentProjects()
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4 max-w-[1400px]">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Learn the basics of home insulation and why it's crucial for Surprise homes
            </p>
          </div>
