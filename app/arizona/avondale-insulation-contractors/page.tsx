...
async function getAvondaleContractors() {
  try {
    ...
    // Filter contractors who are based in Avondale (business_city from their business address)
    ...
    const avondaleContractors = contractors?.filter((contractor: any) => {
      const isBasedInAvondale = contractor.business_city?.toLowerCase() === 'avondale'
      return isBasedInAvondale
    }) || []
...
const avondaleAreaCities = [
  { name: 'Avondale', population: '275,987' },
      ...
      <section className="py-8 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="rounded-lg overflow-hidden shadow-lg">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d424562.4818431687!2d-111.95077996445466!3d33.30689243162149!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s[d%]+!2sAvondale%2C+AZ!5e0!3m2!1sen!2sus!4v1709562834567"
              width="100%"
              height="450"
              style={{ border: 0 }}
              allowFullScreen
