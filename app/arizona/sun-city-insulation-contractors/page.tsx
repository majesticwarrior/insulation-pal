...
async function getSunCityContractors() {
  try {
    ...
    // Filter contractors who are based in Sun City (business_city from their business address)
    ...
    const sunCityContractors = contractors?.filter((contractor: any) => {
      const isBasedInSunCity = contractor.business_city?.toLowerCase() === 'sun city'
      return isBasedInSunCity
    }) || []
      ...
      <section className="py-8 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="rounded-lg overflow-hidden shadow-lg">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d42424.204835627!2d-112.3192353!3d33.6006094!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x872b3f8e8e8e8e8d%3A0x7e8f01e1da73e80!2sSun+City%2C+AZ!5e0!3m2!1sen!2sus!4v1709562834567"
              width="100%"
              height="450"
              style={{ border: 0 }}
              allowFullScreen
