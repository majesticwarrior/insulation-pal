...
// Generate dynamic metadata based on Peoria contractor data
export async function generateMetadata(): Promise<Metadata> {
  try {
    const contractors = await getPeoriaContractors()
    const contractorCount = contractors.length
    const topContractor = contractors[0]
    
    const baseTitle = 'Peoria Insulation Contractors'
    const baseDescription = 'Find the best insulation contractors in Peoria, AZ'
    
    return {
      title: `Peoria Insulation Contractors, Find Top Rated Local Companies Near You`,
      ...
      keywords: [
        ...
        'Peoria attic insulation',
        'Peoria spray foam insulation',
        'Peoria wall insulation',
        'Peoria basement insulation',
        'Peoria crawl space insulation',
        'Peoria energy efficiency',
        'Arizona insulation services',
        'Peoria insulation quotes',
        'licensed insulation contractors Peoria',
        'verified insulation professionals Peoria'
      ],
      openGraph: {
      ...
      alternates: {
        canonical: 'https://insulationpal.com/arizona/peoria-insulation-contractors',
      },
    }
  } catch (error) {
    return {
      title: 'Peoria Insulation Contractors - InsulationPal',
      description: 'Find the best insulation contractors in Peoria, AZ. Get free quotes from licensed professionals.',
    }
  }
}


// Fetch Peoria contractors from Supabase database
async function getPeoriaContractors() {
  try {
    // Get contractors based in Peoria (business city from their profile)
...
// Add Peoria area cities with 50k+ population
const peoriaAreaCities = [
  { name: 'Peoria', population: '275,987', slug: 'peoria' },
...
export default async function PeoriaInsulationContractors() {
  ...
  const cityStats = {
    ...
    averageRating: peoriaContractors.length > 0 ? 
      (peoriaContractors.reduce((sum: number, contractor: any) => sum + contractor.rating, 0) / peoriaContractors.length).toFixed(1) : 
      '4.8',
    totalContractors: peoriaContractors.length,
    jobsCompleted: peoriaContractors.reduce((sum: number, contractor: any) => sum + contractor.jobsCompleted, 0)
  }
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-700 mb-8">
              ...
              licensed professionals who understand Peoria's unique climate challenges.
            </p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-3 gap-8">
            <Card>
              <CardHeader>
                <CardTitle className="text-[#0a4768]">Insulation Types for Peoria</CardTitle>
              </CardHeader>
              <CardContent>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="space-y-8">
            {peoriaContractors.map((contractor: any) => (
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {peoriaAreaCities.map((city, index) => (
      ...
      <section className="py-8 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="rounded-lg overflow-hidden shadow-lg">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d424562.4818431687!2d-111.95077996445466!3d33.30689243162149!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s[d%]+!2sPeoria%2C+AZ!5e0!3m2!1sen!2sus!4v1709562834567"
              width="100%"
              height="450"
              style={{ border: 0 }}
              allowFullScreen
              ...
              title="Peoria, Arizona - Service Area Map"
            />
          </div>
          <div className="text-center mt-6">
            <p className="text-gray-600 mb-4">
              Our certified insulation contractors serve all cities and communities throughout Peoria and the surrounding East Valley area.
            </p>
            <Button 
              asChild 
              variant="outline"
            ...
            >
              <Link 
                href="https://www.google.com/maps/place/Peoria,+AZ"
                target="_blank"
      ...
      <section className="py-16 bg-[#D6D6D6] text-[#0a4768]">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">
            Ready to Improve Your Peoria Home?
          </h2>
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Connect with Peoria's most trusted insulation contractors. Get free quotes from verified professionals 
            who understand the unique insulation needs of desert homes.
          </p>
          <QuoteButton className="bg-[#F5DD22] hover:bg-[#f0d000] text-[#0a4768] font-semibold px-8 py-3 text-lg">
            Get Peoria Quotes Now
          </QuoteButton>
        </div>
      </section>
