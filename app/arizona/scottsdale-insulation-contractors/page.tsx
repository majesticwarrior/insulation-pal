...
async function getScottsdaleContractors() {
  try {
    ...
    // Filter contractors who are based in Scottsdale (business_city from their business address)
    ...
    const scottsdaleContractors = contractors?.filter((contractor: any) => {
      const isBasedInScottsdale = contractor.business_city?.toLowerCase() === 'scottsdale'
      return isBasedInScottsdale
    }) || []
