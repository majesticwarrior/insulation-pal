...
async function getGlendaleContractors() {
  try {
    ...
    // Filter contractors who are based in Glendale (business_city from their business address)
    ...
    const glendaleContractors = contractors?.filter((contractor: any) => {
      const isBasedInGlendale = contractor.business_city?.toLowerCase() === 'glendale'
      return isBasedInGlendale
    }) || []
