...
async function getTucsonContractors() {
  try {
    ...
    // Filter contractors who are based in Tucson (business_city from their business address)
    ...
    const tucsonContractors = contractors?.filter((contractor: any) => {
      const isBasedInTucson = contractor.business_city?.toLowerCase() === 'tucson'
      return isBasedInTucson
    }) || []
